...
<form:form method="POST" modelAttribute="userAcctForm" class="needs-validation" novalidate="true">
    <div class="row row-gap-3 mt-5">
        <div class="col-12 col-md-6">
            ...
            <form:input type="text" path="username" class="form-control" required="true" minlength="4" pattern="[A-Za-z0-9]*"/>
        ...
        <div class="col-12 col-md-6">
            ...
            <form:input type="password" path="password" class="form-control" minlength="6" required="true"/>
